...
exports.getTodosMeninos = (req, res, next) => {
    /*res.status(200).send({
...
//INSERE UM MENINO
exports.postInsereMenino = (req, res, next) =>{
...
exports.getUmMenino = (req, res, next) => {
...
//ALTERA UM MENINO
exports.patchAlterarMenino = (req, res, next) =>{
...
//EXCLUI UM MENINO
exports.deleteExcluirMenino = (req, res, next) =>{
