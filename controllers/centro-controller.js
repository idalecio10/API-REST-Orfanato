...
exports.getTodosCentros = (req, res, next) => {
    /*res.status(200).send({
...
//INSERE UM CENTRO
exports.postInsereCentro = (req, res, next) =>{
...
exports.getUmCentro = (req, res, next) => {
...
//ALTERA UM CENTRO
exports.patchAlterarCentro = (req, res, next) =>{
...
//EXCLUI UM CENTRO
exports.deleteExcluirCentro = (req, res, next) =>{
