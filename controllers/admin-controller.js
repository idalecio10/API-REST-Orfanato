...
exports.getTodosAdmin = (req, res, next) => {
    /*res.status(200).send({
...
exports.postInsereAdmin = (req, res, next) =>{
...
exports.getUmAdmin = (req, res, next) => {
...
exports.patchAlterarAdmin = (req, res, next) =>{
...
exports.deleteExcluirAdmin = (req, res, next) =>{
